# from https://web.archive.org/web/20120219234624/https://rjoris.home.xs4all.nl/files/graphmatching/20080608/mwmatching.py
import inspect
...
def maxWeightMatching(edges, maxcardinality=False):
    ...
    for (i, j, w) in edges:
        ...
        if j >= nvertex:
            nvertex = j + 1
    print(f"{inspect.getframeinfo(inspect.currentframe()).lineno}")
